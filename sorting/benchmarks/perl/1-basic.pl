...
Benchmark: timing 100 iterations of LEX ASC, LEX DESC, LEX DESC NEG, LEX DESC REV, NUM ASC, NUM DESC, NUM DESC NEG, NUM DESC REV...
...
LEX DESC NEG: 30 wallclock secs (29.88 usr +  0.10 sys = 29.98 CPU) @  3.34/s (n=100)
...
NUM DESC NEG: 18 wallclock secs (18.14 usr +  0.02 sys = 18.16 CPU) @  5.51/s (n=100)
...
LEX DESC NEG: 32 wallclock secs (31.57 usr +  0.12 sys = 31.69 CPU) @  3.16/s (n=100)
...
NUM DESC NEG: 18 wallclock secs (17.76 usr +  0.01 sys = 17.77 CPU) @  5.63/s (n=100)
...
LEX DESC NEG: 26 wallclock secs (26.32 usr +  0.00 sys = 26.32 CPU) @  3.80/s (n=100)
...
NUM DESC NEG: 16 wallclock secs (16.05 usr +  0.00 sys = 16.05 CPU) @  6.23/s (n=100)
...
LEX DESC NEG: 28 wallclock secs (26.63 usr +  0.02 sys = 26.65 CPU) @  3.75/s (n=100)
...
NUM DESC NEG: 19 wallclock secs (18.96 usr +  0.00 sys = 18.96 CPU) @  5.27/s (n=100)
